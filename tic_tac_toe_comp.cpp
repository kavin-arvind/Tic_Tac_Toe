...
bool oppwincheck(){
    for(int i=0;i<=2;i++){
        if((a[i]==a[i+3] && 0==a[i+6] && a[i]==1)){draw_o(i+6,2);return 1;}
        else if((a[i+3]==a[i+6] && 0==a[i] && a[i+3]==1)){draw_o(i,2);return 1;}
        else if((a[i]==a[i+6] && 0==a[i+3] && a[i]==1)){draw_o(i+3,2);return 1;}
        }
    for(int i=0;i<=6;i=i+3){
        if(a[i]==a[i+1] && 0==a[i+2] && a[i]==1){draw_o(i+2,2);return 1;}
        else if(a[i+1]==a[i+2] && 0==a[i] && a[i+1]==1){draw_o(i,2);return 1;}
        else if(a[i]==a[i+2] && 0==a[i+1] && a[i]==1){draw_o(i+1,2);return 1;}
        }
    if(a[0]==a[4] && 0==a[8] && a[0]==1) {
        draw_o(8,2);
        return 1;}
    if(a[4]==a[8] && 0==a[0] && a[4]==1) {
        draw_o(0,2);
        return 1;}
    if(a[0]==a[8] && 0==a[4] && a[0]==1) {
        draw_o(4,2);
        return 1;}
    if(a[2]==a[4] && 0==a[6] && a[2]==1) {
        draw_o(6,2);
        return 1;}
    if(a[4]==a[6] && 0==a[2] && a[4]==1) {
        draw_o(2,2);
        return 1;}
    if(a[2]==a[6] && 0==a[4] && a[2]==1) {
        draw_o(4,2);
        return 1;}
    return 0;
    }
bool ourwincheck(){
    for(int i=0;i<=2;i++){
        if((a[i]==a[i+3] && 0==a[i+6] && a[i]==2)){draw_o(i+6,2);return 1;}
        else if((a[i+3]==a[i+6] && 0==a[i] && a[i+3]==2)){draw_o(i,2);return 1;}
        else if((a[i]==a[i+6] && 0==a[i+3] && a[i]==2)){draw_o(i+3,2);return 1;}
        }
    for(int i=0;i<=6;i=i+3){
        if(a[i]==a[i+1] && 0==a[i+2] && a[i]==2){draw_o(i+2,2);return 1;}
        else if(a[i+1]==a[i+2] && 0==a[i] && a[i+1]==2){draw_o(i,2);return 1;}
        else if(a[i]==a[i+2] && 0==a[i+1] && a[i]==2){draw_o(i+1,2);return 1;}
        }
    if(a[0]==a[4] && 0==a[8] && a[0]==2) {
        draw_o(8,2);
        return 1;}
    if(a[4]==a[8] && 0==a[0] && a[4]==2) {
        draw_o(0,2);
        return 1;}
    if(a[0]==a[8] && 0==a[4] && a[0]==2) {
        draw_o(4,2);
        return 1;}
    if(a[2]==a[4] && 0==a[6] && a[2]==2) {
        draw_o(6,2);
        return 1;}
    if(a[4]==a[6] && 0==a[2] && a[4]==2) {
        draw_o(2,2);
        return 1;}
    if(a[2]==a[6] && 0==a[4] && a[2]==2) {
        draw_o(4,2);
        return 1;}
    return 0;
    }
...
while(1){
    ...
    if(check())break;
    flag=0;
    if(ourwincheck()){flag++;p=2;}
    else if(oppwincheck()){flag++;p=1;}
    x=0;
    if(flag==0){
        x=0;
        for(int i=0;i<=8;i++){if(a[i]==0){draw_o(i,2);x++;break;}}
        if(x==0){p=3;break;}
        }
...
wait(3);
//cout<<"completed";
if(p==3){cout<<"draw match!! try again :)"<<endl;}
else if(p==1){cout<<"you won the computer!"<<endl;}
